...
def main():
    ...
    parser.add_argument(
        ...
        help="Path to COCO JSON (default: ../../wbia-core/tests/test-dataset/...)",
    )
    parser.add_argument(
        "--coco-images",
        type=str,
        default="../../wbia-core/tests/test-dataset/images/train2020",
        help="Path to COCO images directory (default: ../../wbia-core/tests/test-dataset/...)",
    )
    parser.add_argument(
        "--results-dir",
        type=str,
